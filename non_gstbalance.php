...
<body class="sb-nav-fixed">
    ...
    if (isset($_POST['submit'])) {
        ...
        $current_balance_WT = $balance;

        // Fetch the latest balance from the database
        $balance_query = "SELECT balance,balance_WT FROM account ORDER BY id DESC LIMIT 1";
        ...
        $sql = "INSERT INTO account (particulars, tex_type, gst, deposite, withdraw, balance, balance_WT, date) 
            VALUES ('$particulars', 'NONGST', '$gst', '$deposit', '$withdraw', '$current_balance', '$current_balance_WT', '$date')";
