                    ...
                    <h2 class="my-2">Dashboard</h>
                                                ...
                                                <div class="card-inner">
                                                    ...
                                                    <div class="card-icon-wrapper">
                                                        <i class="material-icons"><i
                                                                class="fa fa-list-alt text-white fs-2"
                                        ...
                                        <div
                                            ...
                                            <div class="mdc-card info-card info-card--info">
                                                <div class="card-inner">
                                                    ...
                                                    <div class="card-icon-wrapper">
                                                        <i class="material-icons"><i
                                                                class="fa fa-briefcase text-white fs-2"
                                                                aria-hidden="true"></i></i>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                                            <div class="mdc-card">
                                                ...
                                                <div
                                                    ...
                                                    <h5 class="card-sub-title mb-2 mb-sm-0">Sales performance revenue
                                                        based
                                                        by country</h5>
                                                        ...
                                                        <div class="mdc-menu mdc-menu-surface" tabindex="-1">
                                                            <ul class="mdc-list" role="menu" aria-hidden="true"
                                                                ...
                                                                <li class="mdc-list-item" role="menuitem">
                                                                    <h6 class="item-subject font-weight-normal">Back
                                                                    </h6>
                                                                </li>
                                                                <li class="mdc-list-item" role="menuitem">
                                                                    <h6 class="item-subject font-weight-normal">Forward
                                                                    </h6>
                                                                </li>
                                                                <li class="mdc-list-item" role="menuitem">
                                                                    <h6 class="item-subject font-weight-normal">Reload
                                                                    </h6>
                                                                </li>
                                                                <li class="mdc-list-divider"></li>
                                                                <li class="mdc-list-item" role="menuitem">
                                                                    <h6 class="item-subject font-weight-normal">Save
                                                                        As..
                                                                    </h6>
                                                                </li>
                                                            </ul>
                                            ...
                                            <div class="mdc-card">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex justtify-content-between align-items-center">
                                                        <p class="d-none d-sm-block text-muted tx-12 mb-0 mr-2">Goal
                                                            reached
                                                        </p>
                                                                    ...
                                                                    <div class="mdc-tab-scroller__scroll-content">
                                                                        <button class="mdc-tab mdc-tab--active"
                                                                            ...
                                                                            <span class="mdc-tab__content">
                                                                                <span
                                                                                    class="mdc-tab__text-label">1W</span>
                                                                            </span>
                                                                            <span
                                                                        ...
                                                                        <button class="mdc-tab mdc-tab" role="tab"
                                                                            ...
                                                                            <span class="mdc-tab__content">
                                                                                <span
                                                                                    class="mdc-tab__text-label">1M</span>
                                                                            </span>
                                                                            <span
                                                                        ...
                                                                        <button class="mdc-tab mdc-tab" role="tab"
                                                                            ...
                                                                            <span class="mdc-tab__content">
                                                                                <span
                                                                                    class="mdc-tab__text-label">3M</span>
                                                                            </span>
                                                                            <span
                                                                                class="mdc-tab-indicator mdc-tab-indicator">
                                                                                <span
                                                                        ...
                                                                        <button class="mdc-tab mdc-tab" role="tab"
                                                                            ...
                                                                            <span class="mdc-tab__content">
                                                                                <span
                                                                                    class="mdc-tab__text-label">1Y</span>
                                                                            </span>
                                                                            <span
                                                                                class="mdc-tab-indicator mdc-tab-indicator">
                                                                                <span
                                                                        ...
                                                                        <button class="mdc-tab mdc-tab" role="tab"
                                                                            ...
                                                                            <span class="mdc-tab__content">
                                                                                <span
                                                                                    class="mdc-tab__text-label">ALL</span>
                                                                            </span>
                                                                            <span
                                                                                class="mdc-tab-indicator mdc-tab-indicator">
                                                                                <span
                        ...
                        <div class="row mb-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="card   mb-4">
                                    <div class="card-body"><i class="fas fa-user fs-4 me-3"></i><b>9999</b> Employees
                                    </div>
